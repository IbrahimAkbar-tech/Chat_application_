...
public class ChatFragment extends Fragment {
    ...
    void setupRecyclerView(){
        ...
        Query query = FirebaseUtil.allChatRoomReference()
                .whereArrayContains("userId", FirebaseUtil.currentUserId()).orderBy("lastMessageTimestamp", Query.Direction.DESCENDING);
